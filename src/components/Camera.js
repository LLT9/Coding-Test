...
const Camera = () => {
    return(
        <>
         <div className="position-relative shadow img-outer bg-white d-flex p-3 justify-content-center rounded-circle align-items-center border border-1 border-secondary opacity-50">
